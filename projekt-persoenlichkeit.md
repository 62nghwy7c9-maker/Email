# Projekt Persönlichkeit — Startwissen

Zweck: Diese Datei ins Claude-Projekt „Persönlichkeit" legen (Projektwissen).
Ziel des Projekts: Kira lernt sich besser kennen, holt alles aus sich heraus, optimiert sich gezielt.

---

## 1. Wer ich bin

- Kira Moewes. Mache gerade **Abitur**.
- **15.000 € im Depot**, spare und investiere selbst.
- **Erster Kunde vorhanden:** Ich baue für eine Firmengruppe (4 Firmen, Bau/Immobilien) ein KI-E-Mail-System — non-technical, mit Claude als Werkzeug.
- Ich arbeite strukturiert: Phase für Phase, mit Dokumentation und Abnahmen.

## 2. Persönlichkeitstest (16personalities, Juli 2026)

**Ergebnis: ENTJ-T „Kommandeurin"** — aber Grenzfall:

| Achse | Wert | Bedeutung |
|---|---|---|
| Energie | 65 % Extravertiert | klar E |
| Verstand | 74 % Intuitiv | stärkster Wert — groß denken |
| Wesensart | 58 % Rational | **fast Mitte** — Selbstbild eher Gefühl (F) |
| Taktiken | 65 % Strukturiert | klar J |
...
- Mehrfach, von verschiedenen Menschen: **„die netteste Person, die ich kenne"**.
- Meine Direktheit macht meine Nettigkeit glaubwürdig — bei mir weiß man, woran man ist.
...
- **Struktur** — Phasen, Pläne, Durchziehen
- **Kritisches Denken** — ich glaube nichts blind, auch keine Tests
- **Feines Gespür** — ich merke, wenn etwas nicht stimmt
- **Selbstehrlichkeit** — ich beschreibe mich, wie ich bin, nicht wie ich wirken will

## 5. Schwächen / wunde Punkte
...
- **Innere Zweifel** (turbulent) — außen sicher, innen selbstkritisch

## 6. Mein Spannungsfeld

Kontrolle **und** Nähe · Leistung **und** Bedeutung · Vorankommen **und** gut zu Menschen sein.
Kein Fehler — mein Entwicklungsmotor.
...
- Plan: Kundenprojekt liefern → Referenz → weitere Kunden → skalieren
- Nach dem Abi (empfohlen): BWL (Führung/Finance)
...
- [ ] Mehr über mich: Alltag, Umfeld, Freundschaften, Familie
- [ ] Was mir Energie gibt / raubt
- [ ] Konkrete Gewohnheiten, die ich aufbauen oder ablegen will
- [ ] Meine größten Ängste und Blockaden
- [ ] Wie Erfolg für mich in 5 Jahren konkret aussieht

## So arbeite mit mir (verbindlich)

- Einfache Sprache. **Direkt und ehrlich** — kein Herumreden, keine Schmeichelei.
- Phase für Phase, Abnahme nach jeder Phase.
- Dokumente/PDFs: wenig Text, viel Weißraum, Stichpunkte, eine Akzentfarbe.
